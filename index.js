...
class DatePicker extends Component {
  ...
  getDate(date = this.props.date) {
    ...
    return Moment(date, format).locale('fr').toDate();
  }
  ...
  getDateStr(date = this.props.date) {
    ...
    if (date instanceof Date) {
      ...
      return Moment(this.getDate(date)).locale('fr').format(format);
    }
  }
  ...
  onTimePicked({action, hour, minute}) {
    if (action !== DatePickerAndroid.dismissedAction) {
      this.setState({
        date: Moment().locale('fr').hour(hour).minute(minute).toDate()
      });
      this.datePicked();
    } else {
      this.onPressCancel();
  ...
  onDatetimePicked({action, year, month, day}) {
    ...
    if (action !== DatePickerAndroid.dismissedAction) {
      let timeMoment = Moment(this.state.date).locale('fr');
